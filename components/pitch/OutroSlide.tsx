...
const VIDEO_SRC = '/hls/templates/ambient-smoke-layers/1080p/index.m3u8';

function TelegramIcon({ size }: { size: string }) {
  return (
    <svg style={{ width: size, height: size }} viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className="relative z-10 flex flex-col w-full h-full" style={{ color: 'white' }}>
        ...
        >
          ...
          >
            Start Creating &
            <br />
            <span style={{ opacity: 0.7 }}>Selling Today</span>
          </h2>
          ...
          >
            24 AI-generated templates live now. On-chain payments on Monad.
            HLS streaming for instant playback. Whether you&apos;re a creator,
            streamer, or presenter — cinematic backgrounds are now $3 away.
          </p>
