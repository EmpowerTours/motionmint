...
const VIDEO_SRC = '/hls/templates/ambient-molten-gold/1080p/index.m3u8';
    ...
    <div className="relative w-full h-full overflow-hidden bg-black">
      ...
      >
        ...
        >
          ...
          >
            &ldquo;Every presentation deserves a cinematic backdrop. AI makes it possible for $3.&rdquo;
          </blockquote>
        </div>
      </div>
    </div>
