  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Arrow keys Navigate / F Fullscreen
        </div>
        ...
        >
            ...
            {slides.map((_, i) => (
              <button
                ...
                style={{
                  ...
                  height: 6,
                  backgroundColor:
                    i === currentSlide ? 'rgba(255,255,255,0.9)' : 'rgba(255,255,255,0.3)',
          ...
          <div className="flex items-center" style={{ gap: 8 }}>
            <NavButton onClick={goPrev} disabled={currentSlide === 0}>
              <ChevronLeft style={{ width: 'clamp(14px, 1.2vw, 20px)', height: 'clamp(14px, 1.2vw, 20px)' }} />
            </NavButton>
            <NavButton onClick={goNext} disabled={currentSlide === total - 1}>
